...
setLoading(true);
  ...
  useEffect(() => {
    // Replace this with your own word-image data or fetch from an API
    const wordsData = [
 ...
 wrongaud.play();
    ...
    <div className='py-[80px] w-full '>
  {
      ...
      />
        ...
        <IconBtn onclick={clickdone} className='w-[100px] bg-blue-100 p-1 rounded-md hover:bg-blue-200'>Submit</IconBtn> 
  <IconBtn outline={true} onclick={clickres} className='w-[100px] bg-brown-100  p-1 rounded-md hover:bg-brown-300'>RestartGame</IconBtn> 
        </div>
